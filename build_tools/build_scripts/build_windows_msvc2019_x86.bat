...
REM Detect Qt 5.15.x for MSVC2019 x86 (32-bit)
set "QT_PREFIX_PATH=%QT_PREFIX_PATH%"
if not defined QT_PREFIX_PATH if exist "C:\Qt\5.15.2\msvc2019" set "QT_PREFIX_PATH=C:\Qt\5.15.2\msvc2019"
if not defined QT_PREFIX_PATH if exist "C:\Qt\5.15.1\msvc2019" set "QT_PREFIX_PATH=C:\Qt\5.15.1\msvc2019"
if not defined QT_PREFIX_PATH if exist "C:\Qt\5.15.0\msvc2019" set "QT_PREFIX_PATH=C:\Qt\5.15.0\msvc2019"
if not defined QT_PREFIX_PATH (
	for /D %%D in ("C:\Qt\5.*") do (
		if exist "%%D\msvc2019" (
			set "QT_PREFIX_PATH=%%D\msvc2019"
			goto :qt_found
		)
	)
)
...
if defined QT_PREFIX_PATH (
	...
	echo WARNING: Qt MSVC2019 (x86) not found. Proceeding without CMAKE_PREFIX_PATH.
